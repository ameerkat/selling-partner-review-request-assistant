...
def scan_and_solicit(minimum_order_age_days,
                     lwa_client_id,
                     lwa_client_secret,
                     lwa_refresh_token,
                     dryrun = False, 
    ...
    if dryrun:
        logging.warning("NOTICE: THIS IS A DRYRUN ☀")
    ...
    logging.info(f"Requesting orders created between {created_after} and {created_before}")
    ...
    logging.debug("Requesting feedback for orders.")
    ...
    logging.info("Requested for orders: " + ",".join(orders_requested))
